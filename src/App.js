...
class App extends Component {
  ...
  renderNoSongsFound = () => (
    <div className="no_found_Container">
      <p className="no_found_heading">No Songs Found</p>
    </div>
  )
    ...
    return (
      <div className="app_container">
        <div className="top_container">
          <h1 className="main_heading">Ed Sheeran</h1>
          <p className="singer">Singer</p>
        </div>
        <div className="bottom_container">
          <div className="heading_and_input">
            <h1 className="main_heading">Songs Playlist</h1>
          ...
          {filteredList.length === 0 ? (
            ...
            <ul className="songs_ul_Container">
